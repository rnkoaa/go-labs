...
set mouse=a
set operatorfunc=<SNR>64_go
set runtimepath=~/.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-surround,~/.vim/plugged/vim-repeat,~/.vim/plugged/vim-fugitive,~/.vim/plugged/lightline.vim,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-go,~/.vim/plugged/emmet-vim,~/.vim/plugged/goyo.vim,~/.vim/plugged/limelight.vim,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-commentary,~/.vim/plugged/markdown-preview.nvim,~/.vim/plugged/nord-vim,~/.vim/plugged/coc-css,~/.vim/plugged/coc-json,~/.vim/plugged/coc-html,~/.vim/plugged/coc-yaml,~/.vim/plugged/onedark.vim,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim82,/usr/local/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
...
silent only
silent tabonly
cd ~/workspace/go-labs/json-placeholder
...
tabnew
tabrewind
edit pkg/jsonplaceholder/user.go
...
normal! 0
tabnext
edit cmd/json-placeholder/main.go
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((22 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
...
tabnext 2
set stal=1
badd +35 cmd/json-placeholder/main.go
badd +0 pkg/jsonplaceholder/user.go
